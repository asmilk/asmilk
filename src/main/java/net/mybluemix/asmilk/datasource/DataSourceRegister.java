...
public abstract class DataSourceRegister {
	...
	public void setSystemProperty(Database database, String driver, String url, String username, String password,
			String c3p0MaxSize) {
		LOG.info("{}: {}", PROPERTY_JPA_VENDOR_ADAPTER_DATABASE, database);
